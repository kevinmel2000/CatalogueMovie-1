...
public class ImagesBannerWidget extends AppWidgetProvider {
    ...
    public static final String EXTRA_ITEM = "com.example.muas.cataloguemovie.EXTRA_ITEM";
    public static final String ON_CLICK_FAVORITE_ACTION = "com.example.muas.cataloguemovie.ON_CLICK_FAVORITE_ACTION";
